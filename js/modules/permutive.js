...
const load = () => {
  ...
  jsLoader([`//cdn.permutive.com/${projectId}-web.js`]);
};
...
const galleryClick = () => {
  const sendPermutiveGalleryEvent = () => {
    ...
    window.permutive.addon('web', galleryData);
  };
...
export const initPermutiveReadyWithTimeout = () => {
  //permutive-supplied code to introduce a timeout when initialising segments
