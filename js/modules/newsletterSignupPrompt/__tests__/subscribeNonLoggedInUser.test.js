...
import { __setup as __setUpDispatchCustomEvent } from '../../../utils/dispatchCustomEvent';
...
describe('subscribeNonLoggedInUser()', () => {
  ...
  const TEST_NEWSLETTER = 'receiveIndyHealthNews';
    ...
    describe('when user has ticked the offers checkbox', () => {
      ...
      it('should post newsletters to api', async () => {
        ...
        expect(mockPost).toHaveBeenCalledWith(
          'newsletter-component/submit/lite',
          {
            ...
            email: USER_EMAIL,
            regSourceMethod: 'Article%2BSignpost',
            regSourceNewsletter: 'IND_Health_Newsletter',
            regSourceSection: 'Culture',
          },
        );
      });
      ...
      it('should dispatch custom event', async () => {
        ...
        expect(mockDispatchCustomEvent).toHaveBeenCalledWith(
          ...
          {
            newsletter: 'IND_Health_Newsletter',
          },
        );
      });
    });
