...
// TODO: Should this come from props somewhere, or a constants file?
const COMMENTING_REG_SOURCE_METHOD = 'Commenting';
...
const initViafora = () => {
  ...
  window.vf.$prepublish((channel, event, ...args) => {
    ...
    if (channel === 'authentication' && event === 'required') {
      ...
      openLoginSidebar(COMMENTING_REG_SOURCE_METHOD);
