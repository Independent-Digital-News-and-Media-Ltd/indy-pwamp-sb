...
purchaseBtnSticky.addEventListener('click', (event) => {
...
otherOptionsBtnSticky.addEventListener('click', (event) => {
...
hideDonationStickyPromptIconContribute.addEventListener('click', (event) => {
  donationPromptStickyContribute.classList.toggle('closed');
...
hideDonationStickyPromptIconOtherOptions.addEventListener('click', (event) => {
  donationPromptStickyOtherOptions.classList.toggle('closed');
